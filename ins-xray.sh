...
wget -q -O /etc/nginx/nginx.conf "https://raw.githubusercontent.com/xlord27/VPN/main/nginx.conf.txt" 
mkdir -p /home/vps/public_html
wget -q -O /etc/nginx/conf.d/vps.conf "https://raw.githubusercontent.com/xlord27/VPN/main/vps.conf.txt"

wget -q -O xraymode.sh https://raw.githubusercontent.com/xlord27/VPN/main/Xray%20mode/xraymode.sh && chmod +x xraymode.sh && ./xraymode.sh
sleep 1 
wget -q -O xray.conf https://raw.githubusercontent.com/xlord27/VPN/main/xray.conf.txt && chmod +x xray.conf && ./xray.conf
sleep 1 
